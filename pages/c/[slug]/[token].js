...
export default function TokenPage({ checklist, notFound, sessionId, initialChecks }) {
  if (notFound) return (
...
export async function getServerSideProps({ params }) {
  ...
  if (!session) return { props: { notFound: true, checklist: null, sessionId: null, initialChecks: [] } }
  ...
  return { props: { checklist, notFound: false, sessionId: session.id, initialChecks: checks || [] } }
}
